...
func AuthorizationCode(code, state string) (*AccessToken, error) {
	...
	resp, err := resty.New().R().
		...
		SetQueryParam("client_id", viper.GetString("qq.client_id")).
		SetQueryParam("client_secret", viper.GetString("qq.client_secret")).
...
func GetUserInfo(accessToken string) (*UserInfo, error) {
	...
	resp, err := resty.New().R().
		SetQueryParam("access_token", accessToken).
		SetQueryParam("oauth_consumer_key", viper.GetString("qq.client_id")).
