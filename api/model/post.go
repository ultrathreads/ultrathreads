...
type Post struct {
	...
	LastReplyUserId int64     `gorm:"index:idx_post_last_reply_user_id" json:"lastReplyUserId" form:"lastReplyUserId"` // 最后回复用户ID
	LastRepliedAt   time.Time `gorm:"index:idx_post_last_replied_at" json:"lastRepliedAt" form:"lastRepliedAt"`        // 最后回复时间
	CreatedAt       time.Time `gorm:"index:idx_post_created_at" json:"createdAt" form:"createdAt"`                     // 创建时间
	UpdatedAt       time.Time `gorm:"index:idx_post_updated_at" json:"updatedAt" form:"updatedAt"`                     // 更新时间
...
type PostTag struct {
	...
	LastRepliedAt time.Time `gorm:"index:idx_post_tag_last_replied_at" json:"lastRepliedAt" form:"lastRepliedAt"` // 最后回复时间
