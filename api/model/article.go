...
type Article struct {
	...
	Share       bool      `gorm:"not null" json:"share" form:"share"`                                // 是否是分享的文章，如果是这里只显示文章摘要，原文需要跳往原链接查看
	...
	CreatedAt   time.Time `gorm:"index:idx_article_created_at" json:"createdAt" form:"createdAt"`    // 创建时间
